...
public class Lexer {
            ...
            // check for traditional EI and more content to come.
                ...
                if (!(pos + 4 < streamBytes.length)) {
                    ...
                    try {
                        ...
                        if (tmp instanceof Integer && ((Integer) tmp) != OperandNames.NO_OP &&
    ...
    private Integer startComment() throws IOException {
//        int oldPos = pos;
        do {
            pos++;
        }
...
//            byte[] read = new byte[pos-oldPos];
//            System.arraycopy(streamBytes, oldPos,read,0, read.length);
//            logger.finer(new String(read));
//        }
        // we ignore comments
        return OperandNames.NO_OP;
    }
        ...
        while (!(streamBytes[pos] == '>' && streamBytes[pos + 1] == '>')) {
            if (count == 1) {
                ...
                if (key instanceof Integer &&
                        ((Integer) key) == OperandNames.NO_OP) {
                    return h;
                }
                count++;
            } else if (count == 2) {
