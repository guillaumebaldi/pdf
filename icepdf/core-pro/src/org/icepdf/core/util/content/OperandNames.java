...
public class OperandNames {
    ...
    public static final HashMap<Integer, String> OPP_LOOKUP = new HashMap<Integer, String>();
    ...
    static {
        ...
        OPP_LOOKUP.put(75, "OP_PERCENT");
        OPP_LOOKUP.put(76, "OP_NULL");
