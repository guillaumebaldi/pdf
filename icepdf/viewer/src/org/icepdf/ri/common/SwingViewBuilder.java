...
public class SwingViewBuilder {
    ...
    public JMenuBar buildCompleteMenuBar() {
		...
		addToMenuBar(menuBar, buildTestMenu());
	...
	public JMenu buildTestMenu() {
		JMenu fileMenu = new JMenu(messageBundle.getString("viewer.menu.test.label"));
		return fileMenu;
	}
    ...
    public JToolBar buildCompleteToolBar(boolean embeddableComponent) {
		...
		if (PropertiesManager.checkAndStoreBooleanProperty(propertiesManager, PropertiesManager.PROPERTY_SHOW_TOOLBAR_TESTS))
            addToToolBar(toolbar, buildTestsToolBar());
	...
	public JToolBar buildTestsToolBar() {
        JToolBar toolbar = new JToolBar();
        commonToolBarSetup(toolbar, false);
        addToToolBar(toolbar, buildFormTestButton(Images.SIZE_LARGE));
        return toolbar;
    }
	...
	public JToggleButton buildFormTestButton(final String imageSize) {
        JToggleButton btn = makeToolbarToggleButton(
                messageBundle.getString("viewer.toolbar.tool.forms.highlight.label"),
                messageBundle.getString("viewer.toolbar.tool.forms.highlight.tooltip"),
                "open", Images.SIZE_LARGE, buttonFont);
        if (viewerController != null && btn != null)
            viewerController.setFormTestButton(btn);
        return btn;
    }
